    ...
    <header class="admin-header">
        <div class="container">
            <div class="admin-header-content">
                ...
                <nav class="admin-nav">
                    <a href="admin-dashboard_db.php" class="active">Dashboard</a>
        ...
        <div class="container">
            ...
            <div class="quick-actions">
                ...
                <div class="action-buttons">
                    <a href="admin-add-article_db.php" class="action-btn primary">
                        <span class="icon">➕</span>
                        නව ප්‍රවෘත්තිය එක් කරන්න
                    </a>
                    <a href="admin-dashboard_db.php" class="action-btn secondary">
                        <span class="icon">📊</span>
                        වාර්තා බලන්න
                    </a>
            ...
            <div class="articles-management">
                <div class="section-header">
                    ...
                    <a href="admin-add-article_db.php" class="add-btn">නව ප්‍රවෘත්තිය</a>
                </div>
                ...
                <div class="articles-table">
                                ...
                                <?php foreach ($articles as $article): ?>
                                    <tr>
                                        ...
                                        <td class="article-title">
                                            <a href="article_db.php?id=<?= $article['id'] ?>" target="_blank">
                                        ...
                                        <td class="actions">
                                            <a href="admin-edit-article_db.php?id=<?= $article['id'] ?>" class="edit-btn">සංස්කරණය</a>
                    ...
                    <?php else: ?>
                        <div class="no-articles">
                            <p>ප්‍රවෘත්ති නොමැත. <a href="admin-add-article_db.php">පළමු ප්‍රවෘත්තිය එක් කරන්න</a></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
