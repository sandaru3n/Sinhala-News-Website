...
<body>
            ...
            <div class="header-content">
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        ...
                        <li><a href="category_db.php?cat=politics" <?= $category_slug === 'politics' ? 'class="active"' : '' ?>>දේශපාලන</a></li>
                        <li><a href="category_db.php?cat=sports" <?= $category_slug === 'sports' ? 'class="active"' : '' ?>>ක්‍රීඩා</a></li>
                        <li><a href="category_db.php?cat=technology" <?= $category_slug === 'technology' ? 'class="active"' : '' ?>>තාක්ෂණය</a></li>
                        <li><a href="category_db.php?cat=business" <?= $category_slug === 'business' ? 'class="active"' : '' ?>>ව්‍යාපාර</a></li>
                        <li><a href="category_db.php?cat=entertainment" <?= $category_slug === 'entertainment' ? 'class="active"' : '' ?>>විනෝදාස්වාදය</a></li>
                    </ul>
                </nav>
                ...
                <section class="articles-list">
                            ...
                            <?php foreach ($articles as $article): ?>
                                <article class="category-article">
                                    ...
                                    <div class="article-content">
                                        ...
                                        <h2><a href="article_db.php?id=<?= $article['id'] ?>"><?= htmlspecialchars($article['title']) ?></a></h2>
                                        <p><?= htmlspecialchars($article['summary']) ?></p>
                                        <a href="article_db.php?id=<?= $article['id'] ?>" class="read-more">සම්පූර්ණයෙන් කියවන්න</a>
                                    </div>
                                </article>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <?php else: ?>
                        <div class="no-articles">
                            ...
                            <a href="index_db.php" class="back-home">මුල් පිටුවට යන්න</a>
                        </div>
                    <?php endif; ?>
                </section>
                        ...
                        <ul class="other-categories">
                            <?php foreach ($all_categories as $cat): ?>
                                <?php if ($cat['slug'] !== $category_slug): ?>
                                    <li>
                                        <a href="category_db.php?cat=<?= htmlspecialchars($cat['slug']) ?>">
                                ...
                                <?php foreach ($popular_articles as $article): ?>
                                    <article class="popular-item">
                                        ...
                                        <div class="popular-content">
                                            <h4><a href="article_db.php?id=<?= $article['id'] ?>"><?= htmlspecialchars($article['title']) ?></a></h4>
                    ...
                    <?php if (is_logged_in()): ?>
                        <div class="widget">
                            ...
                            <div class="admin-links">
                                <a href="admin-dashboard_db.php" class="admin-link">Admin Dashboard</a>
                                <a href="admin-add-article_db.php" class="admin-link">Add Article</a>
                            </div>
                        </div>
                    <?php endif; ?>
                </aside>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        <?php foreach (array_slice($all_categories, 0, 4) as $cat): ?>
                            <li><a href="category_db.php?cat=<?= htmlspecialchars($cat['slug']) ?>"><?= htmlspecialchars($cat['name_sinhala']) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                <div class="footer-section">
    ...
    <nav class="bottom-nav">
        ...
        <a href="category_db.php?cat=politics" class="bottom-nav-item <?= $category_slug === 'politics' ? 'active' : '' ?>">
            <span class="bottom-nav-icon">🏛️</span>
            <span class="bottom-nav-label">දේශපාලන</span>
        </a>
        <a href="category_db.php?cat=sports" class="bottom-nav-item <?= $category_slug === 'sports' ? 'active' : '' ?>">
            <span class="bottom-nav-icon">⚽</span>
