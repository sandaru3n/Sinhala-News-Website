...
<body>
    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        <li><a href="index_db.php" class="active">මුල් පිටුව</a></li>
                    ...
                    <?php if ($featured_article): ?>
                        <div class="featured-article">
                            ...
                            <div class="featured-content">
                                ...
                                <h3><a href="article_db.php?id=<?= $featured_article['id'] ?>"><?= htmlspecialchars($featured_article['title']) ?></a></h3>
                                <p><?= htmlspecialchars($featured_article['summary']) ?></p>
                                <a href="article_db.php?id=<?= $featured_article['id'] ?>" class="read-more">සම්පූර්ණයෙන් කියවන්න</a>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="featured-article">
                            ...
                            <?php foreach ($latest_articles as $article): ?>
                                <article class="news-card">
                                    ...
                                    <div class="news-content">
                                        ...
                                        <h3><a href="article_db.php?id=<?= $article['id'] ?>"><?= htmlspecialchars($article['title']) ?></a></h3>
    ...
    <nav class="bottom-nav">
        <a href="index_db.php" class="bottom-nav-item active">
